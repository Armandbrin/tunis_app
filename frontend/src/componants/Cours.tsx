...
export function Cours({ cours }: CoursProps) {
  return (
    <>
      <a
        className="rounded-lg bg-[#F2F2F2] hover:bg-white h-[40vh] w-[15vw] shadow-[5px_5px_5px_rgba(0,0,0,0.5)] hover:shadow-none transition duration-300 ease-in-out p-3 flex-none"
        href={"" + cours.id}
      >
