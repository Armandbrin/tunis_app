  ...
  return (
    <header className="w-full flex justify-center p-5 border-b border-[#ECEBF5] shadow-[0_2px_10px_rgba(0,0,0,0.5)]">
      ...
      <section className="flex justify-center items-center w-full gap-30">
        ...
        <button className="bg-[#F2F2F2] hover:bg-white text-[#E70013] rounded-lg font-bold px-3 py-2 shadow-[5px_5px_5px_rgba(0,0,0,0.5)] hover:shadow-none transition duration-300 ease-in-out">
          S'inscrire
        </button>
      </section>
    </header>
